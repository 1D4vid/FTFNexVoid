local Translations = {
    ["PT"] = {
        ...
        ["Highlight"] = "Destaques (ESP)",["Visual"] = "Visuais",
        ["Progress"] = "Progresso",
        ["Textures"] = "Texturas",
        ["Fog"] = "Neblina",
        ["Sound"] = "Sons",
        ...
        ["Teleport"] = "Teleporte",
        ["Highlight Config"] = "Config de ESP",["Info"] = "Informações",

        -- Aba: Highlight
        ["ESP Features"] = "Funções de Visão (ESP)",
        ["Esp Players"] = "ESP Jogadores",
        ["Esp outline"] = "Contorno Jogadores",
        ["Esp Tracer Line"] = "Linha (Tracer)",["Tracer Origin"] = "Origem da Linha",
        ...
        ["Color Customization"] = "Cores Personalizadas",["Beast highlight Color"] = "Cor do Brilho da Fera",
        ...
        ["No fog"] = "Sem Neblina",["Black Fog"] = "Neblina Escura",
        ["FlashLight"] = "Lanterna",["Advanced Color Calibrator"] = "Calibrador de Cores Avançado",
        ...
        ["Filter Opacity"] = "Opacidade do Filtro",["Reset Configurations"] = "Redefinir Configurações",

        -- Aba: Advanced
        ["Survivor"] = "Sobrevivente",
        ["No hack fail"] = "Nunca Errar o PC",["Fling"] = "Girar (Fling / Derrubar)",
        ["Anti Ragdoll"] = "Anti-Desmaio/Queda",
        ["Slow Beast"] = "Fera Lenta (Bug)",
        ["Beast Untie Player"] = "Fera Solta Jogadores",["Auto Save (Teleport)"] = "Salvar Amigos (Teleporte)",
        ...
        ["Players"] = "Movimentação do Jogador",["Fast Double Jump"] = "Pulo Duplo Rápido",
        ["Inf Jump"] = "Pulo Infinito",
        ["Shiftlock"] = "Travar Câmera (Shiftlock)",["Fly"] = "Voar (Fly)",
        ...
        ["Menu Keybind:"] = "Tecla do Menu:",["Sets the key to Open and Close this menu."] = "Define a tecla para Abrir e Fechar o menu.",["Save Configurations"] = "Salvar Configurações",["Saves ALL your enabled options (Toggles, Sliders, Inputs) and your Keybind so they load automatically on your next execution."] = "Salva TODAS as suas opções ativas e atalhos para carregar na próxima vez.",["Deletes all saved data and restores the script to its default state."] = "Exclui todos os dados salvos e restaura o script para o padrão.",
        ["Close"] = "Fechar",
    ...
    ["ES"] = {
        ...
        ["Esp outline"] = "Contorno Jugadores",["Esp Tracer Line"] = "Línea Trazadora",
        ...
        ["Only Esp Beast"] = "Solo ESP Bestia",["Hide Name Esp Player"] = "Ocultar Nombres ESP",
        ["Color Customization"] = "Personalización de Color",
        ["Beast highlight Color"] = "Color Brillo Bestia",["Survivor ESP Color"] = "Color Superviviente",
        ["Beast ESP Color"] = "Color Bestia",
        ["Freezepod ESP Color"] = "Color Cápsula",

        -- Aba: Visual["Camera & UI"] = "Cámara e Interfaz",
        ["Fov Changer"] = "Cambiar FOV",
        ["Font Changer"] = "Cambiar Fuente",
        ["stretch screen"] = "Pantalla Estirada",
        ["Visual Name/Level"] = "Nombre/Nivel Falso",["Enable Visuals"] = "Activar Falso",
        ...
        ["Gray characters"] = "Personajes Grises",["Floorbang"] = "Atravesar Suelo",

        -- Aba: Progress (Timers)
        ["Timers & Indicators"] = "Temporizadores e Indicadores",
        ["Computer Progress"] = "Progreso de Computadoras",
        ["Door timer"] = "Tiempo de las Puertas",["GetUp Timer"] = "Tiempo para Levantarse",
        ["ExitDoor Timer"] = "Tiempo de la Puerta de Salida",
        ["BeastPower timer"] = "Tiempo del Poder (Bestia)",["BeastPower Timer V2"] = "Tiempo del Poder V2",
        ...
        ["Filter Opacity"] = "Opacidad del Filtro",["Reset Configurations"] = "Restablecer Configuraciones",
        ...
        ["Auto Save (Silent)"] = "Auto Salvar (Invisible)",["Beast"] = "Bestia",
        ["No Jump Delay"] = "Sin Retraso de Salto",
        ["Hitbox extender"] = "Extender Hitbox",
        ["Show Hitbox"] = "Mostrar Hitbox",
        ["Hitbox Size"] = "Tamaño de Hitbox",["Anti Fling"] = "Anti Fling",
        ["Auto Tie"] = "Atar Automático",["Hit Aura"] = "Aura de Golpe",
        ...
        ["No clip"] = "Atravesar Paredes",["Jump Power"] = "Poder de Salto",
