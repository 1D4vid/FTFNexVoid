local Translations = {["PT"] = {
        -- Menu Lateral (Sidebar)
        ["Highlight"] = "Destaques (ESP)",
        ["Visual"] = "Visuais",
        ["Progress"] = "Progresso",["Textures"] = "Texturas",
        ["Fog"] = "Neblina",
        ["Sound"] = "Sons",
        ["Advanced"] = "Avançado",
        ...
        ["Esp Players"] = "ESP Jogadores",["Esp outline"] = "Contorno Jogadores",
        ["Esp Tracer Line"] = "Linha (Tracer)",
        ["Tracer Origin"] = "Origem da Linha",
        ["Esp Computers"] = "ESP Computadores",
        ["Esp Doors"] = "ESP Portas",["Esp Freezepods"] = "ESP Cápsulas",
        ...
        -- Aba: Visual["Camera & UI"] = "Câmera e Interface",
        ...
        ["Visual Environment"] = "Ambiente Visual",["Hide Leaves (Only Homestead)"] = "Sem Folhas (Mapa Homestead)",
        ...
        -- Aba: Textures["Textures Settings"] = "Configurações de Texturas",
        ["Remove Textures"] = "Remover Texturas",
        ["FpsBooster"] = "Aumentar FPS (FpsBooster)",["Ultra HD Graphics"] = "Gráficos Ultra HD",
        ["Minecraft Texture"] = "Textura de Minecraft",
        ["Double Jump Effects"] = "Efeitos de Pulo Duplo",
        ["Apply"] = "Aplicar",
        ["Mobile Button Jump"] = "Botão de Pulo (Mobile)",["Crosshair Settings"] = "Configurações de Mira",
        ["Cursor Size"] = "Tamanho do Cursor",

        -- Aba: Teleport
        ["Map Objects Teleport"] = "Teleporte para Objetos",
        ["Teleport Computer"] = "Teleportar: Computador",
        ["Teleport Exitdoor"] = "Teleportar: Porta de Saída",
        ["Teleport Freezepods"] = "Teleportar: Cápsula",
        ["Players Teleport"] = "Teleporte de Jogadores",["Refresh"] = "Atualizar Lista",
        ["Teleport"] = "Teleportar",
        
        -- Aba: Sounds
        ["Mute Sounds"] = "Silenciar Sons",
        ["Remove Your Steps"] = "Remover Seus Passos",
        ["Remove Your Jumps"] = "Remover Seus Pulos",["Remove Pc Hack Sounds"] = "Remover Sons de Hack do PC",
        ["No hit sound"] = "Sem Som de Dano",
        ["General"] = "Geral",
        ["Volume Boost"] = "Aumento de Volume",
        ["Custom Sound Packs"] = "Pacotes de Som Customizados",["Default Sounds (Reset All)"] = "Sons Padrões (Resetar Tudo)",
        ["Walk"] = "Andar",
        ["Jump"] = "Pulo",
        ["Fall"] = "Queda",
        ["Normal"] = "Normal",
        ...
        -- Aba: Fog & Calibrator
        ["Fog Settings"] = "Configurações de Neblina",["No fog"] = "Sem Neblina",
        ["Black Fog"] = "Neblina Escura",
        ["FlashLight"] = "Lanterna",
        ["Advanced Color Calibrator"] = "Calibrador de Cores Avançado",
        ["Enable Calibrator"] = "Ativar Calibrador",["Enable FullBright"] = "Ativar Brilho (FullBright)",
        ["Contrast"] = "Contraste",
        ["Brightness"] = "Brilho",
        ...
        ["Auto Save (Silent)"] = "Salvar Amigos (Invisível)",["Beast"] = "Fera (Beast)",
        ...
        ["Close"] = "Fechar",
        ["Exit NexVoidHub"] = "Sair do NexVoidHub",["Are you absolutely sure you want to close the script? You will need to re-execute to open it again."] = "Tem certeza absoluta que deseja fechar o script? Você precisará reexecutar para abri-lo novamente.",
        ["Cancel"] = "Cancelar",
        ["Yes, Exit"] = "Sim, Sair",["Set Key"] = "Definir Tecla",
        ["Reset"] = "Resetar",["Saved Successfully!"] = "Salvo com Sucesso!",
        ["Reset Successfully!"] = "Redefinido com Sucesso!",

        -- Dropdowns
        ["Inferior"] = "Embaixo",["Topo"] = "Cima",
        ["Torso"] = "Peito",
        ["Default"] = "Padrão",
        ["Nenhum"] = "Nenhum"
    },["ES"] = {
        ...
        -- Aba: Highlight Config
        ["Global Settings"] = "Ajustes Globales",["Only Esp Beast"] = "Solo ESP Bestia",
        ...
        ["Survivor ESP Color"] = "Color Superviviente",["Beast ESP Color"] = "Color Bestia",
        ...
        ["Hide Leaves (Only Homestead)"] = "Sin Hojas (Solo Homestead)",["Gray characters"] = "Personajes Grises",
        ...
        ["ExitDoor Timer"] = "Tiempo de la Puerta de Salida",
        ["BeastPower timer"] = "Tiempo del Poder (Bestia)",
        ...
        ["Apply"] = "Aplicar",
        ["Mobile Button Jump"] = "Botón de Salto (Mobile)",
        ["Crosshair Settings"] = "Ajustes de Mira",
        ["Cursor Size"] = "Tamaño del Cursor",
        
        -- Aba: Teleport
        ["Map Objects Teleport"] = "Teletransporte a Objetos",
        ["Teleport Computer"] = "Teletransportar: Computadora",
        ["Teleport Exitdoor"] = "Teletransportar: Puerta",
        ["Teleport Freezepods"] = "Teletransportar: Cápsula",["Players Teleport"] = "Teletransporte de Jugadores",
        ["Refresh"] = "Actualizar Lista",
        ["Teleport"] = "Teletransportar",
        
        -- Aba: Sounds["Mute Sounds"] = "Silenciar Sonidos",
        ["Remove Your Steps"] = "Eliminar Tus Pasos",
        ["Remove Your Jumps"] = "Eliminar Tus Saltos",["Remove Pc Hack Sounds"] = "Eliminar Sonidos de Hack de PC",
        ["No hit sound"] = "Sin Sonido de Daño",
        ["General"] = "General",
        ["Volume Boost"] = "Aumento de Volumen",
        ["Custom Sound Packs"] = "Paquetes de Sonido Personalizados",["Default Sounds (Reset All)"] = "Sonidos Predeterminados (Reiniciar Todo)",
        ["Walk"] = "Caminar",
        ["Jump"] = "Salto",
        ["Fall"] = "Caída",
        ["Normal"] = "Normal",
        ...
        ["No hack fail"] = "Nunca fallar PC",["Fling"] = "Volar Jugadores (Fling)",
        ["Anti Ragdoll"] = "Anti-Desmayo",
        ["Slow Beast"] = "Bestia Lenta",["Beast Untie Player"] = "Bestia Suelta Jugador",
        ["Auto Save (Teleport)"] = "Auto Salvar (Teletransporte)",
        ["Auto Save (Silent)"] = "Auto Salvar (Invisible)",

        ["Beast"] = "Bestia",
        ["No Jump Delay"] = "Sin Retraso de Salto",
        ["Hitbox extender"] = "Extender Hitbox",["Show Hitbox"] = "Mostrar Hitbox",
        ...
        ["Inf Jump"] = "Salto Infinito",["Shiftlock"] = "Bloqueo de Cámara",
        ["Fly"] = "Volar",["Fly Speed"] = "Velocidad de Vuelo",
        ["No clip"] = "Atravesar Paredes",
        ["Jump Power"] = "Poder de Salto",
        ["Jump Power Val"] = "Valor de Salto",
        ["Walkspeed"] = "Velocidad de Caminata",["Speed Value"] = "Valor de Velocidad",
        ...
        ["Close"] = "Cerrar",["Exit NexVoidHub"] = "Salir de NexVoidHub",["Are you absolutely sure you want to close the script? You will need to re-execute to open it again."] = "¿Estás absolutamente seguro de que quieres cerrar el script? Necesitarás volver a ejecutarlo para abrirlo.",
        ["Cancel"] = "Cancelar",["Yes, Exit"] = "Sí, Salir",
        ["Set Key"] = "Fijar Tecla",
        ["Reset"] = "Reiniciar",
