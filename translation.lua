local Translations = {
    ["PT"] = {
        ...
        -- Aba: Highlight
        ["ESP Features"] = "Funções de Visão (ESP)",["Esp Players"] = "ESP Jogadores",
        ...
        ["Esp Freezepods"] = "ESP Cápsulas",["Beast Highlight"] = "Brilho na Fera",

        -- Aba: Highlight Config["Global Settings"] = "Configurações Globais",
        ["Only Esp Beast"] = "Apenas ESP na Fera",
        ["Hide Name Esp Player"] = "Ocultar Nomes no ESP",["Color Customization"] = "Cores Personalizadas",
        ["Beast highlight Color"] = "Cor do Brilho da Fera",
        ["Survivor ESP Color"] = "Cor ESP: Sobrevivente",["Beast ESP Color"] = "Cor ESP: Fera",
        ["Freezepod ESP Color"] = "Cor ESP: Cápsula",

        -- Aba: Visual
        ["Camera & UI"] = "Câmera e Interface",
        ["Fov Changer"] = "Alterar Campo de Visão",["Font Changer"] = "Alterar Fonte da Tela",
        ["stretch screen"] = "Tela Esticada",
        ["Visual Name/Level"] = "Nome/Nível Falso",
        ["Enable Visuals"] = "Ativar Falsificação",
        ["Fake Name"] = "Nome Falso",["Fake Level"] = "Nível Falso",
        ...
        -- Aba: Progress (Timers)["Timers & Indicators"] = "Cronômetros e Indicadores",
        ["Computer Progress"] = "Progresso dos Computadores",
        ["Door timer"] = "Tempo das Portas",
        ["GetUp Timer"] = "Tempo de Levantar",
        ["ExitDoor Timer"] = "Tempo da Porta de Saída",["BeastPower timer"] = "Tempo do Poder (Beast)",
        ["BeastPower Timer V2"] = "Tempo do Poder V2",

        -- Aba: Textures
        ["Textures Settings"] = "Configurações de Texturas",
        ["Remove Textures"] = "Remover Texturas",["FpsBooster"] = "Aumentar FPS (FpsBooster)",
        ["Ultra HD Graphics"] = "Gráficos Ultra HD",
        ["Minecraft Texture"] = "Textura de Minecraft",["Double Jump Effects"] = "Efeitos de Pulo Duplo",
        ["Apply"] = "Aplicar",["Mobile Button Jump"] = "Botão de Pulo (Mobile)",
        ...
        ["Teleport Freezepods"] = "Teleportar: Cápsula",["Players Teleport"] = "Teleporte de Jogadores",
        ["Refresh"] = "Atualizar Lista",["Teleport"] = "Teleportar",

        -- Aba: Fog & Calibrator["Fog Settings"] = "Configurações de Neblina",
        ["No fog"] = "Sem Neblina",
        ["Black Fog"] = "Neblina Escura",
        ["FlashLight"] = "Lanterna",
        ["Advanced Color Calibrator"] = "Calibrador de Cores Avançado",["Enable Calibrator"] = "Ativar Calibrador",
        ...
        ["Slow Beast"] = "Fera Lenta (Bug)",["Beast Untie Player"] = "Fera Solta Jogadores",
        ...
        ["Close"] = "Fechar",
        ["Exit NexVoidHub"] = "Sair do NexVoidHub",["Are you absolutely sure you want to close the script? You will need to re-execute to open it again."] = "Tem certeza absoluta que deseja fechar o script? Você precisará reexecutar para abri-lo novamente.",["Cancel"] = "Cancelar",
        ...
        -- Menu Lateral
        ["Highlight"] = "Destaques (ESP)",["Visual"] = "Visuales",
        ["Progress"] = "Progreso",
        ["Textures"] = "Texturas",
        ["Fog"] = "Niebla",
        ["Sound"] = "Sonido",
        ...
        ["GetUp Timer"] = "Tiempo para Levantarse",["ExitDoor Timer"] = "Tiempo de la Puerta de Salida",
        ...
        ["Teleport Exitdoor"] = "Teletransportar: Puerta",["Teleport Freezepods"] = "Teletransportar: Cápsula",
        ...
        ["FlashLight"] = "Linterna",["Advanced Color Calibrator"] = "Calibrador de Color Avanzado",
        ["Enable Calibrator"] = "Activar Calibrador",
        ["Enable FullBright"] = "Activar FullBright",
        ["Contrast"] = "Contraste",
        ["Brightness"] = "Brillo",
        ["Saturation"] = "Saturación",
        ["Hue Filter"] = "Filtro de Matiz (Color)",["Filter Opacity"] = "Opacidad del Filtro",
        ["Reset Configurations"] = "Restablecer Configuraciones",

        -- Aba: Advanced
        ["Survivor"] = "Superviviente",["No hack fail"] = "Nunca fallar PC",
        ["Fling"] = "Volar Jugadores (Fling)",
        ["Anti Ragdoll"] = "Anti-Desmayo",
        ["Slow Beast"] = "Bestia Lenta",
        ["Beast Untie Player"] = "Bestia Suelta Jugador",
        ["Auto Save (Teleport)"] = "Auto Salvar (Teletransporte)",["Auto Save (Silent)"] = "Auto Salvar (Invisible)",

        ["Beast"] = "Bestia",
        ["No Jump Delay"] = "Sin Retraso de Salto",
        ["Hitbox extender"] = "Extender Hitbox",
        ["Show Hitbox"] = "Mostrar Hitbox",["Hitbox Size"] = "Tamaño de Hitbox",
        ...
        ["Shiftlock"] = "Bloqueo de Cámara",["Fly"] = "Volar",
        ["Fly Speed"] = "Velocidad de Vuelo",["No clip"] = "Atravesar Paredes",
        ...
        -- Menus Extras (Exit, Settings, Player Card)
        ["SETTINGS"] = "CONFIGURACIONES",["Menu Keybind:"] = "Tecla del Menú:",["Sets the key to Open and Close this menu."] = "Establece la tecla para Abrir y Cerrar este menú.",
